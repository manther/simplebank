...
// Source: github.com/manther/simplebank/db/sqlc (interfaces: Store)
...
// DeleteEntriy mocks base method.
func (m *MockStore) DeleteEntriy(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteEntriy", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteEntriy indicates an expected call of DeleteEntriy.
func (mr *MockStoreMockRecorder) DeleteEntriy(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteEntriy", reflect.TypeOf((*MockStore)(nil).DeleteEntriy), arg0, arg1)
}
...
// UpdatEntry mocks base method.
func (m *MockStore) UpdatEntry(arg0 context.Context, arg1 db.UpdatEntryParams) (db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatEntry", arg0, arg1)
	ret0, _ := ret[0].(db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdatEntry indicates an expected call of UpdatEntry.
func (mr *MockStoreMockRecorder) UpdatEntry(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatEntry", reflect.TypeOf((*MockStore)(nil).UpdatEntry), arg0, arg1)
}
